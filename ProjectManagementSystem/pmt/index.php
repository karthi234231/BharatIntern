            ...
            <div class="main-sub-container">
                <form action="?" method="post" enctype="multipart/form-data">
                    <div class="add-user">
                        ...
                        <button type="submit" class="button blue" id="add_user_btn" name="add-user-btn">Add
                            User</button>
                    </div>
                    <div class="operation">
                        <div class="select">
                            <select name="select-user" class="select-user" id="select-user"
                ...
                ?>
                        ...
                        <button type="submit" class="button red" id="delete-user-btn" name="delete-user-btn">Delete
                            User</button>
                    </div>
                    <div class="add-task-section">
                        <input type="text" class="textfeild" id="task-desc" name="task-desc"
                            placeholder="Describe task">
                        <button type="submit" class="button blue" id="add-task-btn" name="add-task-btn">Add
                            Task</button>
                    </div>
                </form>
            </div>
